...
const TEXT = {
    JA: {
        ...
        MAP_LOADED: "ようこそ",
        MAP_LOAD_RETRYING: "エラーが発生ました<br>{0}秒後に再試行します...",
        PROCESSING: "処理中...",
        ...
        SHARE_EVENT_POPUP_SUBTITLE: "記事を自動で開きます",
        SHARE_EVENT_DATA_TITLE: "獅子児祭",
        SHARE_EVENT_INCLUDE_EVTH: "現在のスクロール位置",
    ...
    EN: {
        ...
        SHARE_EVENT_POPUP_SUBTITLE: "Opens this article automatically",
        SHARE_EVENT_DATA_TITLE: "Shishiji festival",
        SHARE_EVENT_INCLUDE_EVTH: "Show current scroll position",
