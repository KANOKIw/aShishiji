...
app.get("/org/completion", drought.useractivity.passedOrg);

app.get("/stamp", drought.resFile(__dirname + "/src/main/stamp/index.html"));


app.post("/org/data", drought.orgauth.data);
